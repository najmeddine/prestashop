...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_56521737e01ff9_29263422',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56521737e01ff9_29263422')) {function content_56521737e01ff9_29263422($_smarty_tpl) {?><div id="search_block_top" class="col-md-3 col-sm-4 "><form id="searchbox" method="get" action="http://127.0.0.1/projects/Prestashop/prestashop/fr/recherche" > <input type="hidden" name="controller" value="search" /> <input type="hidden" name="orderby" value="position" /> <input type="hidden" name="orderway" value="desc" /> <input class="search_query form-control" type="text" id="search_query_top" name="search_query" placeholder="Rechercher" value="" /> <button type="submit" name="submit_search" class="btn btn-default button-search"> <span>Rechercher</span> </button></form></div><?php }} ?>
